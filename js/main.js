...
<p style="text-decoration: none; font-size: 4.5rem; color:orange;">새엄마가 데려온 딸이 전 여친이었다</p>
            <p style="font-family : '고딕';">제목이 이상하다는 지적이 많습니다만, 제가 보면 굉장히 정상적인 이름입니다. 단어를 약간만 섞어보겠습니다. "딸의 전 여친이 새엄마였다", "전 여친의 새 엄마가 딸이었다" "새 엄마가 데려온 딸이 전 남친이었다" 보십시오. 얼마나 정상적인 제목입니까? 애니도 딱 제목만큼 평범하고 평작이었습니다. </p>
         
<p style="text-decoration: none; font-size: 4.5rem; color:orange;">아픈건 싫으니까 방어력에 올인하려고 합니다</p>
            <p style="font-family : '고딕';">전투씬을 스킵하면 재밌는 애니였습니다. 저만 백합물인줄 알았나요</p>
<p style="text-decoration: none; font-size: 4.5rem; color:blue;">카구야님은 고백받고 싶어 3기 울트라 로맨틱</p>
            <p style="font-family : '고딕';">마지막화의 연출은 애니메이션 역사에 남을 자격이 있다고 생각합니다. 모든 것이 완벽했고, 예술적이었습니다. 아름답습니다.</p>
<p style="text-decoration: none; font-size: 4.5rem; color:blue;">마법소녀 마도카 마기카 신편 반역의 이야기</p>
            <p style="font-family : '고딕';">마마마는 신세대의 성경입니다. tva가 구약이라면 반역은 신약입니다. tva도 명작이었지만, 반역의 이야기가 있기에 마마마는 역사에 남은 애니가 되었다고 생각합니다. 에바 신극장판이 망했다고 해서 EOE와 파가 망작인 건 아닙니다. 마마마는 이제 어떻게 되든 역사적인 애니로 남을 것입니다.</p>
<p style="text-decoration: none; font-size: 4.5rem; color:blue;">바케모노가타리/모노가타리 시리즈 2nd 시즌</p>
            <p style="font-family : '고딕';">모노가타리 시리즈는 제가 반다이보다 샤프트를 더 좋아하게 만들어줬습니다. 그 시작인 바케모노가타리와 시즌2는 캐릭터성과 스토리 풀이에 있어 길이 남을 명작이라고 생각합니다. 특별한 평가가 없다면 모노가타리 시리즈는 제목만 표기합니다.</p>
<p style="text-decoration: none; font-size: 4.5rem; color:green;">니세모노가타리/네코모노가타리(흑)/츠키모노가타리</p>
<p style="text-decoration: none; font-size: 4.5rem; color:blue;">오와리모노가타리(상중/하)/키즈모노가타리(철혈열혈냉혈편)</p>
